        ...
        <div class="card shadow-2xl border border-white/50 dark:border-slate-700/50 bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl sm:rounded-2xl" style="background-color: transparent !important;">
          <div class="card-body p-4 sm:p-6">
            <div class="d-flex justify-content-between align-items-start mb-3">
              ...
              <div class="text-end">
                <button type="submit" class="btn btn-primary" style="background-color: #20c997; border-color: #20c997;">保存</button>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-section">
                  ...
                  <input type="text" name="desired_position" class="form-control" value="{{ old('desired_position') }}" placeholder="例: Webエンジニア">
                </div>
                ...
                <div class="form-section">
                  ...
                  <div id="historyRows">
                    @for ($i = 0; $i < $histCount; $i++)
                      @php $h = $oldHistories[$i] ?? ['start_year'=>'','start_month'=>'','end_year'=>'','end_month'=>'','company_name'=>'','job_description'=>'']; @endphp
                ...
                <div class="form-section">
                  ...
                  @php $oldLicenses = old('licenses', []); $licCount = max(1, count($oldLicenses)); @endphp
                  <div id="licenseRows">
                ...
                <div class="form-section">
                  ...
                  <textarea name="motivation" class="form-control" rows="5">{{ old('motivation') }}</textarea>
                </div>
